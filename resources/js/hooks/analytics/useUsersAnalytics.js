...
export const useUsersAnalytics = (data, dateFilter, isAllPeriod) => {
    return useMemo(() => {
        ...
        const others = nonAdmins.length - clients.length - analysts.length;
        ...
        filteredOrders.forEach(order => {
            ...
            if (assignedAnalysts.length > 0) {
                ...
                assignedAnalysts.forEach(analyst => {
                    ...
                    analystTestCounts[name] = (analystTestCounts[name] || 0) + sampleCount;
                });
            }
        });
        ...
        const avgAnalystsPerOrder = ordersWithAnalysts > 0
