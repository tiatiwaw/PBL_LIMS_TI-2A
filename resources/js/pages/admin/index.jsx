                        ...
                        <ResponsiveContainer width="100%" height={300}>
                            <PieChart>
                                <Pie
                                    ...
                                    dataKey="value"
                                >
                                    {dashboard?.resourceDistribution.map(
                                        (entry, index) => (
                                            <Cell
                                                key={`cell-${index}`}
                                                fill={entry.color}
                        ...
                        <div className="space-y-4">
                            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-2xl font-bold">
                                        {dashboard?.quickSummary.totalResources}
                                    </span>
                                </div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl">
                            ...
                            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-2xl font-bold">
                                        {dashboard?.quickSummary.rataRataHarian}
                                    </span>
                                </div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-2xl font-bold">
                                        {dashboard?.quickSummary.efisiensi}%
                                    </span>
                                </div>
                            </div>
                        </div>
