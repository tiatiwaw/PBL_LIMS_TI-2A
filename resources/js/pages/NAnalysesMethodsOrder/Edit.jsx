...
export default function Edit() {
  const { fields = [], resource = 'n_analyses_methods_order', item = {}, flash = {} } = usePage().props;
  ...
  function submit(e) {
    e.preventDefault();
    form.put(route(`${resource}.update`, item.id));
  }
    ...
    <div className="p-4 max-w-2xl">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={route(`${resource}.index`)} className="text-gray-700">
            Cancel
          </Link>
        </div>
      </form>
