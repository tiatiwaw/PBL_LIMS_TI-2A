...
import { dummyClients } from "@/data/clients"; // pastikan path ini benar
    ...
    <div className="p-6 rounded-lg">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              {formData.selectedKlien ? formData.selectedKlien.name : "-"}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              {formData.selectedKlien ? formData.selectedKlien.akun : "-"}
            </p>
          </div>

          <div>
            <h3 className="text-lg font-semibold mb-1">Nomor</h3>
            <p className="text-gray-600 text-sm">
              {formData.selectedKlien ? formData.selectedKlien.nomor : "-"}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4">Metode Analisis</h2>
          ...
          <div>
            ...
            <div className="w-full px-4 py-3 bg-gray-300 border border-gray-300 
