...
const steps = [
    { number: 1, name: "Pilih Sampel", icon: Check },
    { number: 2, name: "Edit Reagent & Equipment", icon: RotateCcw },
    { number: 3, name: "Catatan", icon: FileText },
];

export default function RepeatTestStepper({ currentStep = 1 }) {
    return (
        <div className="py-8 rounded-2xl">
            <h2 className="text-2xl font-semibold text-teal-700 mb-2">
                Ulangi Test (Repeat Test)
            </h2>
