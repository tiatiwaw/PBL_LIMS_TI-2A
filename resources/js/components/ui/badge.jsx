    ...
    "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
    {
        variants: {
            variant: {
                ...
                approved: "bg-teal-100 border border-teal-500 text-teal-800",
                received:
                    "bg-purple-100 border border-purple-500 text-purple-800",
                received_test:
                    "bg-indigo-100 border border-indigo-500 text-indigo-800",
                pending_payment:
                    "bg-orange-100 border border-orange-500 text-orange-800",
                paid: "bg-blue-100 border border-blue-600 text-blue-800",
                revision_test:
                    "bg-amber-200 border border-amber-600 text-amber-900",
            },
        },
        defaultVariants: {
            variant: "default",
