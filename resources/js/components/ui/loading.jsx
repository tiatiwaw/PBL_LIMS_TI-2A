          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
              ...
              <div className="flex flex-col items-center gap-2">
                  ...
                  <div className="flex gap-1.5">
                      <span className="w-2 h-2 bg-primary-hijauTua rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
                      <span className="w-2 h-2 bg-primary-hijauTua rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
                      <span className="w-2 h-2 bg-primary-hijauTua rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
                  </div>
              </div>
          </div>
      </div>
