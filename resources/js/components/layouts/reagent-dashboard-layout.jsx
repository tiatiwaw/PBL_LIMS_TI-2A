...
export default function ReagentDashboardLayout({
    children,
    title,
    header = "Hello World!",
}) {
    ...
    const { data: lowStockReagents, isLoading: notificationsLoading } = useLowStockReagents();
    ...
    const notificationCount = useMemo(() => lowStockReagents?.count ?? 0, [lowStockReagents]);
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    <header className="mb-4 md:mb-6">
                        <HeaderCard
                            ...
                            lowStockReagents={lowStockReagents?.data || []}
